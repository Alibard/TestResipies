...
public class ReciptModel {
    ...
    public ReciptModel(String[] ingredients, String publisher, String f2f_url, String title, String source_url, String recipe_id, String image_url, String social_rank, String publisher_url) {
        this.ingredients = ingredients;
        this.publisher = publisher;
        this.f2f_url = f2f_url;
        this.title = title;
